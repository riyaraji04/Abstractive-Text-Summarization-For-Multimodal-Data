...
<body>
  <nav class="navbar navbar-inverse">
    ...
    <div class="container text-center" id="section2">
      <h3>Upload any video below</h3>
            <form id="uploadv" action="upload_video.php" method="POST" enctype="multipart/form-data">
                ...
                <button type="submit" name="submit" class="upload " style="margin-left:40px" OnClientClick="return false;">Upload Video</button>
            </form>
            <br><br><br>
    ...
    <script>
    <?php
        $command = escapeshellcmd('python convideo.py');
